...
const Test_L155 = [
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "'Starry sky' — tingible-body macrophages engulfing the rapidly dying tumor cells", "explanation": "Correct. The 'starry sky' pattern is the histologic hallmark of Burkitt lymphoma — tingible body macrophages clearing apoptotic debris in a sea of rapidly proliferating malignant cells. The 'stars' are tingible body macrophages — benign reactive macrophages phagocytosing the abundant apoptotic bodies generated by the extremely high proliferation rate (Ki-67 nearly 100%, the highest of any human tumor). The 'sky' is the dark sea of malignant medium-sized B cells. This appearance, combined with t(8;14) c-MYC and EBV positivity (endemic form), confirms Burkitt." },
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "Monoclonal IgM with HYPERVISCOSITY and no lytic bone lesions", "explanation": "Correct. Waldenstrom macroglobulinemia is characterized by monoclonal IgM (not IgG/IgA — a large pentameric molecule) produced by lymphoplasmacytoid cells. The pentameric IgM causes HYPERVISCOSITY syndrome (Raynaud, blurred vision, retinal vein 'sausage links,' headache, mucosal bleeding) — a feature distinctly UNCOMMON in MM because MM's IgG/IgA are smaller monomers. Waldenstrom also does NOT typically produce lytic bone lesions or hypercalcemia (unlike MM). >90% of Waldenstrom cases carry the MYD88 L265P mutation. Acute hyperviscosity is managed with PLASMAPHERESIS." },
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "t(14;18) → BCL-2 overexpression → impaired apoptosis", "explanation": "Correct. Follicular lymphoma is defined by t(14;18), which places BCL-2 under the IgH enhancer. Follicular lymphoma is defined by t(14;18) which juxtaposes BCL-2 (chromosome 18) next to the immunoglobulin heavy chain enhancer (chromosome 14). Overexpression of the anti-apoptotic protein BCL-2 prevents normal programmed death of germinal center B cells, allowing their accumulation. Follicular lymphoma is the most common INDOLENT NHL in adults; presents with painless, waxing/waning lymphadenopathy. Excellent prognosis but generally incurable." },
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "CD23", "explanation": "Correct. CD23 is POSITIVE in CLL and NEGATIVE in MCL — the classic immunophenotypic distinction: CLL is CD23+ (an activation marker), while MCL is CD23-. Additional helpers: MCL strongly expresses CYCLIN D1 (from t(11;14)), which is negative in CLL. MCL also has FMC7+ while CLL is FMC7- (CLL has CLLU1+). The CD23 status is the single most reliable initial discriminator." },
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "Fever, drenching night sweats, and weight loss", "explanation": "Correct. The B symptoms are constitutional symptoms that indicate more aggressive disease and worsen prognosis: (1) unexplained fever >38°C, (2) drenching night sweats, and (3) unintentional weight loss >10% of body weight in 6 months. Presence of B symptoms adds a 'B' suffix to the Ann Arbor stage (e.g., stage IIB), upstaging prognosis." },
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "Burkitt 8;14, Follicular 14;18, MCL 11;14", "explanation": "Correct. Burkitt — t(8;14) c-MYC; Follicular — t(14;18) BCL-2; Mantle cell — t(11;14) cyclin D1. The three classic NHL translocations and their oncogenes: BURKITT = t(8;14) deregulating c-MYC (proliferation) | FOLLICULAR = t(14;18) deregulating BCL-2 (anti-apoptosis) | MANTLE CELL = t(11;14) deregulating cyclin D1 (cell cycle). All three juxtapose the oncogene next to the IgH enhancer on chromosome 14, hijacking B-cell transcription to drive overexpression." },
