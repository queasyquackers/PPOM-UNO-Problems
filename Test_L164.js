...
window.Test_L164 = [
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "Spinal/epidural hematoma compressing the cord or cauda equina, causing paralysis; concern is that all anticoagulants increase bleeding risk and a bleed in the closed spinal space can be catastrophic.", "explanation": "Correct. The lecturer placed a star on this point: neuraxial anesthesia (spinal/epidural injection) in a patient on any drug that increases bleeding risk — anticoagulants, antiplatelets, fibrinolytics — can produce an epidural or spinal hematoma that compresses the cord or cauda equina, causing devastating paralysis. The shared mechanism is that ALL anticoagulant classes (heparins, fondaparinux, DOACs, warfarin) can produce bleeding, and bleeding within the closed bony spinal canal has no room to expand without compressing neural tissue. The lecturer instructed that one must ALWAYS be aware of the patient's anticoagulant/antiplatelet therapy before neuraxial procedures — agents must be held for appropriate intervals based on each drug's half-life and clearance." },
